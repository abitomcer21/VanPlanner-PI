...
function cargarRecordatorios() {
    ...
    fetch(`https://back.vanplanner.duckdns.org/ObtenerRecordatoriosServlet?usuario_id=${usuarioId}`)
        .then(response => {
            if (!response.ok) {
...
function agregarRecordatorio() {
    ...
    fetch('https://back.vanplanner.duckdns.org/AddRecordatorioServlet', {
        method: 'POST',
        headers: {
...
function toggleRecordatorio(idRecordatorio, completado) {
    ...
    fetch('https://back.vanplanner.duckdns.org/ActualizarRecordatorioServlet', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded'
        },
...
function eliminarRecordatorio(idRecordatorio) {
    ...
    fetch('https://back.vanplanner.duckdns.org/EliminarRecordatorioServlet', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded'
        },
