    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (usuarioEncontrado != null) {
            if (!usuarioEncontrado.isActivo()) {
                ...
                response.getWriter().write("{\"error\":\"inactivo\",\"mensaje\":\"La cuenta está inactiva o ha sido eliminada.\"}");
            } else {
                PrintWriter pw = response.getWriter();
                pw.println(gson.toJson(usuarioEncontrado));
                pw.close();
            ...
            response.getWriter().write("{\"error\":\"no_registrado\",\"mensaje\":\"El usuario no está registrado o la contraseña es incorrecta.\"}");
        }
    }
}